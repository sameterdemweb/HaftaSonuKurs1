...
namespace MvcOrnekProje2.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Maas = table.Column<int>(type: "int", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KdvliFiyat = table.Column<double>(type: "float", nullable: true),
                    ToplamFiyat = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
