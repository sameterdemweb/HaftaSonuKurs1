...
namespace WebSitePanelim.Controllers
{
    public class ReferanslarController : Controller
    {
        ...
        public ReferanslarController(AppIdentityDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Referanslar != null ? 
                          ...
                          Problem("Entity set 'AppIdentityDbContext.Referanslar'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Baslik,Resim,Url,Aciklama,KisaAciklama,Tarih")] Referans referans)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Baslik,Resim,Url,Aciklama,KisaAciklama,Tarih")] Referans referans)
        {
            if (id != referans.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppIdentityDbContext.Referanslar'  is null.");
            }
            var referans = await _context.Referanslar.FindAsync(id);
            if (referans != null)
            {
