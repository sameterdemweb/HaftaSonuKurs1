...
namespace HastaneProje
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                options.LoginPath = "/UyeIslemleri/Giris"; // Kullanýcýnýn login olacaðý  sayfa 
                options.LogoutPath = "/UyeIslemleri/Cikis"; // Kiþinin çýkýþ yapmasý için 
                options.AccessDeniedPath = "/UyeIslemleri/ErisimYetkinizYok"; //kiþinin eriþim yetkisi yoksa yönlendirilecek sayfa.
